...
RUN mkdir -p /mnt/disks/bbnews/tts/public /usr/src/app
...
# Create the symlink after copying the application code
RUN if [ ! -L /usr/src/app/public ]; then ln -s /mnt/disks/bbnews/tts/public /usr/src/app/public; fi

# Expose the port the app runs on
EXPOSE 3000

# Run the application
CMD [ "node", "TTSPreProcessorServer.js" ]